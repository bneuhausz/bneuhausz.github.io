...
<p>I&#39;ve wrote, at length, about how customizing and theming works in newer versions of Angular Material, so I&#39;ll not go into that here and just leave a <a href="https://bneuhausz.dev/blog/customizing-angular-material-20">link</a> to that post instead.</p><p>Anyway, bringing back the old <code>color</code> attribute&#39;s functionality is surprisingly easy using the new mixins. All you have to do to achieve that, assuming you use the prebuilt color palettes and the azure palette is your primary palette, is defining some rules in your <code>styles.scss</code>:</p><pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#F97583">@use</span><span style="color:#9ECBFF"> '@angular/material'</span><span style="color:#F97583"> as</span><span style="color:#FFAB70"> mat</span><span style="color:#E1E4E8">;</span></span>
